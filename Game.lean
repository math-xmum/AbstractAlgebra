...
Dependency BasicLean → BasicFunctions → EquivalenceRelation → BasicGroupTheory → GroupHomomorphism → GroupAction
Dependency BasicFunctions → Magma → BasicGroupTheory
